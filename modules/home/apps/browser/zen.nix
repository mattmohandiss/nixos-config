{ browserDefaults, pkgs, ... }:

let
  firefoxExtensionsDir = "share/mozilla/extensions/{ec8030f7-c20a-464f-9b0e-13a3a9e97384}";
  ublockOrigin = builtins.elemAt browserDefaults.extensions 0;
  bitwarden = builtins.elemAt browserDefaults.extensions 1;
  lockPrefs = prefs:
    builtins.mapAttrs
      (_: value: {
        Value = value;
...
in
{
  programs.zen-browser = {
    ...
    policies = {
      ...
      Preferences = lockPrefs (browserDefaults.commonSettings // browserDefaults.themeSettings) // {
